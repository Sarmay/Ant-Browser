...
export const FINGERPRINT_PRESETS: FingerprintPreset[] = [
  ...
  },
  {
    ...
    name: 'macOS 15 Sequoia / Chrome / 设计师',
    description: '模拟 Mac 设计师用户，macOS 15.2，中文环境，Retina 分辨率',
    config: {
      brand: 'Chrome',
      platform: 'macos',
  ...
  {
    id: 'mac-chrome-jp',
    name: 'macOS 15 Sequoia / Chrome / 日本用户',
    description: '模拟日本 Mac 用户，macOS 15.5，Chrome 浏览器，日语环境',
    config: {
      brand: 'Chrome',
      platform: 'macos',
  ...
  },
  {
    ...
    name: 'macOS 13 Ventura / Chrome / 美国-教育',
    description: '模拟美国大学教育网 Mac 用户，macOS 13.7，英文环境 (en-US)',
    config: {
      brand: 'Chrome',
      platform: 'macos',
  ...
  {
    id: 'mac-chrome-monterey-office',
    name: 'macOS 12 Monterey / Chrome / 办公',
    description: '模拟较旧 Mac 办公用户，macOS 12.7，中文环境，1440x900',
    config: {
      brand: 'Chrome',
      platform: 'macos',
  ...
  {
    id: 'mac-chrome-sonoma-cn',
    name: 'macOS 14 Sonoma / Chrome / 办公',
    description: '模拟国内 Mac 办公用户，macOS 14.7，中文环境，1920x1080',
    config: {
      brand: 'Chrome',
      platform: 'macos',
  ...
  {
    id: 'mac-chrome-sonoma-us',
    name: 'macOS 14 Sonoma / Chrome / 美国',
    description: '模拟美国 Mac 用户，macOS 14.7，英文环境，1920x1080',
    config: {
      brand: 'Chrome',
      platform: 'macos',
      platformVersion: '14.7.1',
  ...
  {
    id: 'mac-chrome-sequoia-hk',
    name: 'macOS 15 Sequoia / Chrome / 香港',
    description: '模拟香港 Mac 商务用户，macOS 15.6，繁体中文环境',
    config: {
      brand: 'Chrome',
      platform: 'macos',
  ...
  {
    id: 'mac-chrome-tahoe-office',
    name: 'macOS 26 Tahoe / Chrome / 办公',
    description: '模拟较新 Mac 办公用户，macOS 26.0，中文环境，1920x1080',
    config: {
      brand: 'Chrome',
      platform: 'macos',
  ...
  {
    id: 'mac-chrome-tahoe-us',
    name: 'macOS 26 Tahoe / Chrome / 美国',
    description: '模拟美国高配 Mac 用户，macOS 26.4，英文环境，2560x1440',
    config: {
      brand: 'Chrome',
      platform: 'macos',
  ...
  {
    id: 'mac-chrome-tahoe-uk',
    name: 'macOS 26 Tahoe / Chrome / 英国',
    description: '模拟英国 Mac 办公用户，macOS 26.4，英文环境 (en-GB)',
    config: {
      brand: 'Chrome',
      platform: 'macos',
      platformVersion: '26.4.1',
